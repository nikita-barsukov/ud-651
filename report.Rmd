...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, fig.cap='Distribution of crime rate in census block groups'}
...
Spatial plots of crime reports
--------------
...
Let's find quantifiable parameters to visual clues described in sections above and look at correlation matrix: how number of crime reports by block group correlate with our four demographic parameters.
